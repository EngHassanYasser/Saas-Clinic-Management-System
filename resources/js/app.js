...
import { vacationApp } from "./Vacations/vacationApp";
import { DoctorApp } from "./Doctors/DoctorApp";
import { ScheduleApp } from "./Schedules/ScheduleApp";
import { DoctorServiceApp } from "./DoctorServices/DoctorServiceApp";
import { SubscriptionApp } from "./Subscriptions/SubscriptionApp";
import { ComplainttApp } from "./Complaintts/ComplainttApp";
...
Alpine.data("VacationApp", vacationApp);
Alpine.data("DoctorApp", DoctorApp);
Alpine.data("ScheduleApp", ScheduleApp);
Alpine.data("DoctorServiceApp", DoctorServiceApp);
Alpine.data("SubscriptionApp", SubscriptionApp);
Alpine.data("ComplainttApp", ComplainttApp);
