  <!-- Card -->
                <div
                    class="bg-white border border-gray-100 rounded-2xl p-5 flex gap-5 shadow-sm hover:shadow-lg transition-all duration-300">

                    <!-- Image -->
                    <div class="w-28 h-28 flex-shrink-0">
                        <img src="https://via.placeholder.com/150" class="w-full h-full object-cover rounded-2xl"
                            alt="clinic">
                    </div>
