<div class="relative col-span-2" x-data="{ open: false, selected: null }" class="relative">
    <input type="hidden" x-model="form.plan.id" name="plan_id">
    ...
    <button type="button" @click="open = !open"
        ...
        <span x-text="form.plan.id? form.plan.name : 'اختر الخطة'"
            :class="form.plan.id ? 'text-gray-900' : 'text-gray-400'"></span>
    ...
    <div x-show="open" @click.outside="open = false" x-transition
        ...
        <template x-for="plan in plans" :key="plan.id">
            <button type="button"
                ...
                :class="form.plan?.id === plan.id ? 'bg-blue-100 text-blue-700 font-semibold' : ''">
