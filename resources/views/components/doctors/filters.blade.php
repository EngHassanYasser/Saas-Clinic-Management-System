    ...
    <div class="bg-white rounded-xl border border-gray-100 p-4 mb-6 flex flex-wrap items-center gap-3">
        ...
        <div class="flex items-center gap-1 border border-gray-200 rounded-lg p-1">
            <button id="gridViewBtn" onclick="setView('grid')"
                class="w-8 h-8 rounded-md flex items-center justify-center text-white bg-teal-500 transition">
                <i class="fa fa-grip text-sm"></i>
            </button>
            <button id="listViewBtn" onclick="setView('list')"
                class="w-8 h-8 rounded-md flex items-center justify-center text-gray-400 hover:text-gray-600 transition">
