    ...
    <div x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0 scale-90 translate-y-2"
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            <h2 class="text-base font-bold text-gray-800"
                x-text="editId ? 'تعديل بيانات العيادة' : 'إضافة عيادة جديدة'"></h2>
        ...
        <div class="p-6 grid grid-cols-2 gap-4">
            ...
            <div class="col-span-2">
                <label class="block text-xs font-semibold text-gray-500 mb-1.5">اسم العيادة <span
                        class="text-red-400">*</span></label>
                <input x-model="form.name" type="text" placeholder="مثال: عيادة الأمل"
            ...
            <div>
                <label class="block text-xs font-semibold text-gray-500 mb-1.5">البريد الإلكتروني <span
                        class="text-red-400">*</span></label>
                <input x-model="form.email" type="email" placeholder="clinic@example.com"
                    class="w-full border border-gray-200 bg-gray-50 text-sm px-3 py-2.5 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 transition">
            </div>

            <div>
                <label class="block text-xs font-semibold text-gray-500 mb-1.5">المدينة <span
                        class="text-red-400">*</span></label>
                <input x-model="form.city" type="text" placeholder="القاهرة"
                    class="w-full border border-gray-200 bg-gray-50 text-sm px-3 py-2.5 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 transition">
            </div>
            ...
            <div>
                <label class="block text-xs font-semibold text-gray-500 mb-1.5">الباقة</label>
