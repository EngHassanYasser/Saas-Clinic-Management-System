                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-4 py-3">
                            ...
                            <div class="flex items-center gap-2.5">
                                ...
                                <div
                                    class="w-8 h-8 rounded-lg bg-teal-100 flex items-center justify-center text-xs font-medium flex-shrink-0"
                                    x-text="v.doctor.name.charAt(0)">
                                </div>

                                <span
                                    class="font-medium text-gray-700"
                                    x-text="v.doctor.name">
                                </span>
                        ...
                        <td
                            ...
                            x-text="formatDate(v.start_date)">
                        </td>

                        {{-- إلى --}}
                        <td
                            class="px-4 py-3 text-gray-600"
                            x-text="formatDate(v.end_date)">
                        </td>
                        ...
                        <td class="px-4 py-3">
                            ...
                            <span
                                ...
                                x-text="daysBetween(v.start_date,v.end_date) + ' يوم'">
                            </span>
