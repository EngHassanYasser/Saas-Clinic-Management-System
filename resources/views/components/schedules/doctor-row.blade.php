  ...
  <div class="flex items-center justify-between p-4 cursor-pointer select-none" @click="open = !open">
      ...
      <div class="flex items-center gap-3">
          ...
          <div>
              <p class="text-sm font-medium text-gray-800"><span x-text="currentDoctor?.name"></span></p>
              <p class="text-xs text-gray-400"><span x-text="currentDoctor?.speciality_name"></span> —
      ...
      <div class="flex items-center gap-2">
          <button type="button" @click.stop="openAddModal(currentDoctor);showModel = true"
